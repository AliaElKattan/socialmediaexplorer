require("./proseplay.css");

function $parcel$export(e, n, v, s) {
  Object.defineProperty(e, n, {get: v, set: s, enumerable: true, configurable: true});
}

$parcel$export(module.exports, "ProsePlay", () => $c6f0f7cb2207299e$export$bb601a587602e2b4);

const $02d0362f14f6c3d4$var$windowTemplate = document.createElement("div");
$02d0362f14f6c3d4$var$windowTemplate.classList.add("proseplay-window");
const $02d0362f14f6c3d4$var$listTemplate = document.createElement("div");
$02d0362f14f6c3d4$var$listTemplate.classList.add("proseplay-list");
$02d0362f14f6c3d4$var$windowTemplate.append($02d0362f14f6c3d4$var$listTemplate);
const $02d0362f14f6c3d4$var$linkRefTemplate = document.createElement("sup");
$02d0362f14f6c3d4$var$linkRefTemplate.classList.add("proseplay-link-ref");
const $02d0362f14f6c3d4$var$BUFFER_TIME = 15;
let $02d0362f14f6c3d4$var$PADDING;
const $02d0362f14f6c3d4$var$mouse = {
    x: 0,
    y: 0
};
class $02d0362f14f6c3d4$export$cec157cbbbaf65c9 {
    links = [];
    horizontal = false;
    constructor(parent){
        this.el = $02d0362f14f6c3d4$var$windowTemplate.cloneNode(true);
        ...
        this.functionNames = [];
        this.functions = {};
        $02d0362f14f6c3d4$var$PADDING = parseInt(getComputedStyle(parent).fontSize) * 0.3;
    }
    /**
   ...
   */ activateChoice(choice) {
        if (!choice) {
            ...
            else this.listEl.style.left = `${-Math.abs(choice.offsetLeft) + $02d0362f14f6c3d4$var$PADDING}px`;
        }
   ...
   */ slideToChoice(choiceIndex, duration) {
        ...
        }, $02d0362f14f6c3d4$var$BUFFER_TIME);
        this.pointerUp();
        this.pointerOut();
    ...
    getNearestChoice(pos) {
        ...
        this.choices.forEach((choice)=>{
            let dist = !this.horizontal ? Math.abs(pos + choice.offsetTop) : Math.abs(pos + choice.offsetLeft - $02d0362f14f6c3d4$var$PADDING);
            if (dist < minDist) {
                minDist = dist;
                targetChoice = choice;
            }
   ...
   */ get pos() {
    ...
    handlePointerDown = (e)=>{
        ...
        this.isDragged = true;
        $02d0362f14f6c3d4$var$mouse.x = e.clientX;
        $02d0362f14f6c3d4$var$mouse.y = e.clientY;
    };
    pointerDown() {
        this.el.classList.add("proseplay-hover");
    }
    handlePointerMove = (e)=>{
        ...
        const dist = !this.horizontal ? $02d0362f14f6c3d4$var$mouse.y - e.clientY : $02d0362f14f6c3d4$var$mouse.x - e.clientX;
   ...
   */ setLink(linkIndex, otherWindows) {
        ...
        if (linkIndex) {
            const sup = $02d0362f14f6c3d4$var$linkRefTemplate.cloneNode(true);
...
const $b9b56118470e1236$var$choiceTemplate = document.createElement("div");
$b9b56118470e1236$var$choiceTemplate.classList.add("proseplay-choice");
class $b9b56118470e1236$export$32a7462f6a06cbd5 {
    text = "";
    isCurrent = false;
    constructor(text){
        this.text = text;
        this.el = $b9b56118470e1236$var$choiceTemplate.cloneNode(true);
...
const $c6f0f7cb2207299e$var$lineTemplate = document.createElement("div");
$c6f0f7cb2207299e$var$lineTemplate.classList.add("proseplay-line");
const $c6f0f7cb2207299e$var$samples = {
...
let $c6f0f7cb2207299e$var$EM;
class $c6f0f7cb2207299e$export$bb601a587602e2b4 {
    lines = [];
    windows = [];
    links = [];
    _isExpanded = false;
   ...
   */ constructor(el){
        ...
        $c6f0f7cb2207299e$var$EM = parseInt(getComputedStyle(el).fontSize);
    }
    static createInstance() {
        const container = document.createElement("div");
        container.classList.add("proseplay");
        document.body.appendChild(container);
        const pp = new $c6f0f7cb2207299e$export$bb601a587602e2b4(container);
        return pp;
    }
    /**
   * Load a sample.
   ...
   */ load(name) {
        ...
        this.windows = [];
        this.links = [];
        return this.parse($c6f0f7cb2207299e$var$samples[name]);
    }
    /**
   ...
   */ static load(name) {
        const pp = $c6f0f7cb2207299e$export$bb601a587602e2b4.createInstance();
        return pp.load(name);
    }
    /**
   ...
   */ static parse(str) {
    ...
    constructText(text) {
        this.el.innerHTML = "";
        text.forEach((line)=>{
            const lineEl = $c6f0f7cb2207299e$var$lineTemplate.cloneNode(true);
            ...
            line.forEach((token)=>{
                if (token.strings.length === 1) {
                    ...
                    const window1 = new (0, $02d0362f14f6c3d4$export$cec157cbbbaf65c9)(lineEl);
                    if (token.linkIndex) {
                    ...
                    token.strings.forEach((str)=>window1.addChoice(new (0, $b9b56118470e1236$export$32a7462f6a06cbd5)(str)));
            ...
            line.windows.forEach((window1)=>{
                ...
                window1.choices.forEach((choice, i)=>{
                    ...
                    if (!window1.horizontal) maxWidth = Math.max(maxWidth, choice.el.offsetWidth);
                        ...
                        if (i > 0) maxWidth += $c6f0f7cb2207299e$var$EM;
   ...
   */ snapshot() {
        ...
        this.lines.forEach((line)=>{
            line.tokens.forEach((token)=>{
                if (token instanceof (0, $02d0362f14f6c3d4$export$cec157cbbbaf65c9)) text += token.choices[token.currentIndex].text;
                else text += token;
            });
            text += "\n";
        });
