...
})({"kGhOy":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "3b394694842e1359";
"use strict";
...
},{}],"bMZA2":[function(require,module,exports) {
...
(async function() {
    const data1 = [
        {
            year: "Total encryption",
            count: 10
        },
        {
            year: "Some encryption",
            count: 20
        },
        {
            year: "No encryption",
    ...
    //   }
    // );
    new (0, _autoDefault.default)(document.getElementById("pie-1"), {
        type: "pie",
        data: {
    ...
    new (0, _autoDefault.default)(document.getElementById("pie-2"), {
        type: "pie",
        data: {
    ...
    new (0, _autoDefault.default)(document.getElementById("pie-3"), {
        type: "pie",
        data: {
